...
import { OpenConfigTimeComponent } from 'src/app/dialog/open-config-time/open-config-time.component';
...
export class GoogleSheetComponent implements OnInit {
  ...
  handleTime(){
    const dialogRef = this.dialog.open(OpenConfigTimeComponent, {
      data: {},
      width: '100%',
    });
  }
