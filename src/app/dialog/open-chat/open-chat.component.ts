...
import { BottomSheetSheetFastAnswer, BottomSheetSheetFlows } from 'src/app/tools/list-chat-detailed/list-chat-detailed.component';
...
export class OpenChatComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OpenChatComponent>,
  ...
  ngOnInit() {
    if( this.datas.id ) { this.data = this.datas.whatsappId; this.handleEventFater() }
