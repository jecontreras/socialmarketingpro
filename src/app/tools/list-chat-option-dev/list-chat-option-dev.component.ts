...
@Component({
  selector: 'app-list-chat-option-dev',
  templateUrl: './list-chat-option-dev.component.html',
  styleUrls: ['./list-chat-option-dev.component.scss']
})
export class ListChatOptionDevComponent implements OnInit {
  dataConfig:any = {};
