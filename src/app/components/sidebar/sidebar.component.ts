...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ROUTES = [
      ...
      { path: '/liveChat/aaaaaaaaa', title: this.dataConfig.liveChat,  icon:'ni-pin-3 text-orange', class: '', disabled: ( this.viewProfile === 'usuario' ) || ( this.viewProfile === 'admin' ) || ( this.viewProfile === 'subAdmin' ) },
