...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ROUTES = [
      { path: '/dashboard', title: 'Inicio',  icon: 'ni-tv-2 text-primary', class: '' ,disabled: true },
      ...
      { path: '/flows', title: this.dataConfig.flows,  icon:'ni-pin-3 text-orange', class: '', disabled: ( this.viewProfile === 'visitante' ) || ( this.viewProfile === 'admin' ) || ( this.viewProfile === 'subAdmin' ) || ( this.viewProfile === 'usuario' ) },
